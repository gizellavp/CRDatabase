...
class Surat_Keluar extends CI_Controller
{
    ...
    public function delete_surat()
    {
        ...
        //load data folder
        $data['surat_keluar'] = $this->Surat_Keluar_Model->select_data_surat_byId($id)->row();
        $file = $data['surat_keluar']->file;

        //hapus file dari folder
        $filehapus = './assets/upload/surat_keluar/' . $file;
        unlink($filehapus);

        //hapus data repositori
        $this->Surat_Keluar_Model->delete_surat($id);
    }
}
